...
data_imported = read.csv(file = "Miller_et_al_2020_SL_from_table_S1.csv")
...
plot(sl_for_carbocat$time_kyr,sl_for_carbocat$sea_level_m,type = "l")

## export data

write.table(
  x = sl_for_carbocat$sea_level_m,
  file  = "sea_level_scenarioB.txt",
  col.names = FALSE,
  row.names = FALSE
)
